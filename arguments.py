...
def parse_args():
    parser = argparse.ArgumentParser("Hyperparameters Setting for MAPPO in UAV environment")
    ...
    parser.add_argument("--consider_cloud", type=float, default=True, help="Consider cloud.")
    parser.add_argument("--testing", type=float, default=False, help="Training or Testing?")
